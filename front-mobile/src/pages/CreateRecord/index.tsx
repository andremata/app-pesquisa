...
const CreateRecord = () => {
    ...
    const [selectedGame, setSeletecdGame] = useState('');
    ...
    //ve o ciclo de vida do componente
    //quando inicia o componente executa esse código
    useEffect(() => {
        axios.get(`${BASE_URL}/games`)
        .then(response =>{
            const selectValue = mapSelectValues(response.data);
            setAllGame(selectValue);
        })
        .catch(() => Alert.alert('Erro ao carregar games!'))
    }, []);
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                <RectButton style={styles.button} onPress={handleSubit}>
